...
int	main(void) {
	...
	std::cout << object_3.getName() << " has " << object_3.getHitPoints() << " HP";
	std::cout << " / " << object_3.getEnergyPoints() << " EP";
	std::cout << " / " << object_3.getAttackDamage() << " AD" << std::endl;
